...
text = "Name" +char(9)+ "Surname" +char(9)+...
    ...
    "Mark (after late submission penalty)"+char(9)+...
    "Raw mark"+char(9)+...
...
statistics = statistics + char(9)+char(9)+char(9) + ...
    "Average mark: " + char(9) + ...
    "=AVERAGE(E2:E"+ num2str(num_students+1) +")" + newline;

statistics = statistics + char(9)+char(9)+char(9) + ...
    "Meadian mark: " + char(9) + ...
    "=MEDIAN(E2:E"+ num2str(num_students+1) +")" + newline;

statistics = statistics + char(9)+char(9)+char(9) + ...
    "Standard deviation: " + char(9) + ...
    "=STDEV(E2:E"+ num2str(num_students+1) +")" + newline;

statistics = statistics + char(9)+char(9)+char(9) + ...
    "Max mark: " + char(9) + ...
    "=MAX(E2:E"+ num2str(num_students+1) +")" + newline;


statistics = statistics + char(9)+char(9)+char(9) + ...
    "Min mark: " + char(9) + ...
    "=MIN(E2:E"+ num2str(num_students+1) +")" + newline;
